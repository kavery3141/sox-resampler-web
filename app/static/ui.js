...
function loadUiAddon(src){const script=document.createElement('script');const sep=src.includes('?')?'&':'?';script.src=`${src}${sep}v=20260902d`;script.async=false;document.body.appendChild(script)}
